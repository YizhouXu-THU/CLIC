...
flops_vae, params_vae = get_model_complexity_info(vae, (max_dim,))
flops_classifier, params_classifier = get_model_complexity_info(classifier, (vae.latent_dim,))
print('VAE Flops:', flops_vae, 'VAE Params:', params_vae, end='    ')
print('Classifier Flops:', flops_classifier, 'Classifier Params:', params_classifier)
