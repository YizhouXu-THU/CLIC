...
name = datetime.now().strftime('%Y%m%d-%H%M')+'-CL_bv_num-seed='+str(random_seed)   # for example: '20230509-1544-CL_bv_num-seed=42'
...
for round in range(rounds):
    ...
    if round in [0, 1]:
        ...
        bv_nums = [1, 2, 3, 4]
    index = lib.select_bv_num(bv_nums, size=train_size)
