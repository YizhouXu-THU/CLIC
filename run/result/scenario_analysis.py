...
plt.hist(np.array(bv_bv_dis_lib, dtype=np.float16), bins=50, alpha=0.8, density=True)
plt.hist(np.array(bv_bv_dis_highd, dtype=np.float16), bins=50, alpha=0.8, density=True)
...
plt.figure(figsize=(4, 3))
plt.hist(np.array(bv_av_dis_lib, dtype=np.float16), bins=25, alpha=0.8, density=True)
plt.hist(np.array(bv_bv_dis_highd, dtype=np.float16), bins=25, alpha=0.8, density=True)
...
plt.figure(figsize=(4, 3))
plt.hist(np.array(bv_yaw_lib, dtype=np.float16), bins=50, alpha=0.8, density=True)
plt.hist(np.array(bv_yaw_highd, dtype=np.float16), bins=50, alpha=0.8, density=True)
...
plt.figure(figsize=(4, 3))
plt.hist(np.array(bv_vel_lib, dtype=np.float16), bins=50, alpha=0.8, density=True)
plt.hist(np.array(bv_vel_highd, dtype=np.float16), bins=50, alpha=0.8, density=True)
...
plt.figure(figsize=(4, 3))
plt.hist(np.array(bv_acc_lib, dtype=np.float16), bins=50, alpha=0.8, density=True)
plt.hist(np.array(bv_acc_highd, dtype=np.float16), bins=50, alpha=0.8, density=True)
