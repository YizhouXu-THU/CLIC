...
plt.hist(np.array(bv_bv_dis_lib), bins=50, alpha=0.6, density=True, label='scenario library')
# plt.hist(np.array(bv_bv_dis_highd), bins=50, alpha=0.6, density=True, label='highD dataset')
# plt.legend()
...
plt.figure(figsize=(4, 3))
plt.hist(np.array(bv_av_dis_lib), bins=25, alpha=0.6, density=True, label='scenario library')
# plt.hist(np.array(bv_bv_dis_highd), bins=25, alpha=0.6, density=True, label='highD dataset')
# plt.legend()
...
plt.scatter(np.array(bv_av_pos_x_lib), np.array(bv_av_pos_y_lib), s=2, alpha=0.5, label='BV')
...
plt.figure(figsize=(4, 3))
plt.hist(np.array(bv_yaw_lib), bins=50, alpha=0.6, density=True, label='scenario library')
# plt.hist(np.array(bv_yaw_highd), bins=50, alpha=0.6, density=True, label='highD dataset')
# plt.legend()
plt.xlim(-30, 30)
...
plt.figure(figsize=(4, 3))
plt.hist(np.array(bv_vel_lib), bins=50, alpha=0.6, density=True, label='scenario library')
# plt.hist(np.array(bv_vel_highd), bins=50, alpha=0.6, density=True, label='highD dataset')
# plt.legend()
...
plt.figure(figsize=(4, 3))
plt.hist(np.array(bv_acc_lib), bins=50, alpha=0.6, density=True, label='scenario library')
# plt.hist(np.array(bv_acc_highd), bins=50, alpha=0.6, density=True, label='highD dataset')
# plt.legend()
plt.xlim(-9, 9)
